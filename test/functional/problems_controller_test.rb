...
class ProblemsControllerTest < ActionController::TestCase
  ...
  test "should create problem" do
    assert_difference('Problem.count') do
      post :create, problem: { author: @problem.author, description: @problem.description, title: @problem.title }
    end
  ...
  test "should update problem" do
    put :update, id: @problem, problem: { author: @problem.author, description: @problem.description, title: @problem.title }
    assert_redirected_to problem_path(assigns(:problem))
  end
